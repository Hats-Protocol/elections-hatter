...
This contract is an eligibility module for Hats protocol. It sets eligibility for a hat based on the results of an election (conducted elsewhere) of a given term.
